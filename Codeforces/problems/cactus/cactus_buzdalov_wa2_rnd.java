...
public class cactus_buzdalov_wa2_rnd {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int startVertex = new Random().nextInt(n);
        buildCactus(startVertex, -1, edges);
        DSDS ds = new DSDS(n);

        PrintWriter out = new PrintWriter("cactus.out");
        if (colorGraph(vertices[startVertex], ds) && vertices[startVertex].subtreeSize == 0) {
