...
public class cactus_buzdalov_tl1 {
    ...
    static int[] events;
    static boolean[] xevents;

    static int countCycles;
    static long countOps;
    ...
    public static void main(String[] args) throws IOException {
        ...
        events = new int[compSize];
        xevents = new boolean[compSize];
        ...
        out.close();
//        System.out.println("cycles = " + countCycles + " ops = " + countOps);
    }
}
